 ...
 *
 * @deprecated The auth.expo.io proxy and thus expo-auth-session in Expo Go have been deprecated. Prefer `useAuthRequest` (with `useProxy` set to false)
 *             in combination with an Expo Dev Client build of your application.
 */
